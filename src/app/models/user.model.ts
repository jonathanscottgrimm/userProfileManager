// user.model.ts
import { randJobArea, randJobTitle, randJobDescriptor, randCompanyName, randPhoneNumber, randAddress, Address, randAmount, randCatchPhrase, randSubscriptionPlan } from '@ngneat/falso';
